...
import com.ac10.currencyexchange.databinding.FragmentCurrenciesBinding
import com.ac10.currencyexchange.ui.adapters.CurrencyAdapter
import com.ac10.currencyexchange.ui.adapters.decoration.GridSpacerDecoration
import com.ac10.currencyexchange.ui.dialogs.Dialogs
import com.ac10.currencyexchange.ui.viewmodels.CurrencyViewModel
import com.ac10.currencyexchange.ui.viewmodels.Status
...
class CurrenciesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.currencyValue.observe(viewLifecycleOwner) { state ->
            when (state.status) {
                Status.SUCCESS -> {
                    showData(state.data)
                }
