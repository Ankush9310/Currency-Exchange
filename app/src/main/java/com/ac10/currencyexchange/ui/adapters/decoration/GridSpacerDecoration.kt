package com.ac10.currencyexchange.ui.adapters.decoration
...
class GridSpacerDecoration (
    ...
    override fun getItemOffsets(
        ...
        if (includeEdge) {
            outRect.left = spacingSize - column * spacingSize / columnsNumber // spacing - column * ((1f / spanCount) * spacing)
            outRect.right = (column + 1) * spacingSize / columnsNumber // (column + 1) * ((1f / spanCount) * spacing)
            ...
            outRect.right = spacingSize - (column + 1) * spacingSize / columnsNumber // spacing - (column + 1) * ((1f /    spanCount) * spacing)
